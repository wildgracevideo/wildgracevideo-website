...
const config = {
  runtimeConfig: {
    ...
    stripeInteriorDesignerReelIdeasPriceId: process.env.STRIPE_INTERIOR_DESIGNER_REEL_IDEAS_PRICE_ID,
    sendGridApiKey: process.env.SENDGRID_API_KEY,
    reelIdeasTemplateId: process.env.REEL_IDEAS_TEMPLATE_ID,
    interiorDesignerReelIdeasTemplateId: process.env.INTERIOR_DESIGNER_REEL_IDEAS_TEMPLATE_ID,
